    ...
    <section  id="Resume">
        ...
        <Header.Content>Resume</Header.Content>
          ...
          <Container text className="resumeSec">
            ...
            <List>
                <List.Item>
                    <p><b>Web Development (full-stack):</b> JavaScript, CSS, HTML, AJAX, JQuery, Node, ESLint, Jest (testing), Express, Express-Handlebars, MVC, API, MySQL, MSSQL, Sequelize, MongoDB, NoSQL</p>
